...
SELECT 'Alasan Tidak Hadir' AS title, 'http://localhost:8090/daftarkelas/daftartelatxiic.php' as link;
SELECT 'list' AS component, 'Daftar Telat Kelas XII-C' AS title;
SELECT nama AS title FROM presence.presencelist WHERE kelas = 'XII-C' AND kehadiran = 'Belum Terdata'; 