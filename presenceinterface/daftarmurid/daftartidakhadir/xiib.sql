...
SELECT 'Alasan Tidak Hadir' AS title, 'http://0.0.0.0:8090/daftarkelas/daftartelatxiib.php' as link;
SELECT 'list' AS component, 'Daftar Telat Kelas XII-B' AS title;
SELECT nama AS title FROM presence.presencelist WHERE kelas = 'XII-B' AND kehadiran = 'Belum Terdata' ORDER BY kelas, absen; 