...
SELECT 'Alasan Tidak Hadir' AS title, 'http://0.0.0.0:8090/daftarkelas/daftartelatxiia.php' as link;
SELECT 'list' AS component, 'Daftar Telat Kelas XII-A' AS title;
SELECT nama AS title FROM presence.presencelist WHERE kelas = 'XII-A' AND kehadiran = 'Belum Terdata' ORDER BY kelas, absen; 