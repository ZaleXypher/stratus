...
SELECT 'Daftar Tidak Hadir' AS title, 'daftartidakhadir/xiia.sql' as link;
SELECT 'list' AS component, 'Daftar Kehadiran  Kelas XII-A' AS title;
SELECT nama AS title, kehadiran AS description FROM presence.presencelist WHERE kelas = 'XII-A' ORDER BY absen; 