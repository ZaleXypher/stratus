...
SELECT 'Daftar Tidak Hadir' AS title, 'daftartidakhadir/xiic.sql' as link;
SELECT 'list' AS component, 'Daftar Kehadiran  Kelas XII-C' AS title;
SELECT nama AS title, kehadiran AS description FROM presence.presencelist WHERE kelas = 'XII-C' ORDER BY absen; 